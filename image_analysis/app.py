...
def upload():
	...
	#return redirect(url_for('uploaded_file',
        ...
        request1.file_name =  "/data/home/vincentyao/image_classification/plain_board/imageclassify/app/uploads/" + filename
        ...
        returnbuf = "[" + filename + "]"  + " Classify result: (" + str(len(proto_dat.rsp_res)) + ")"
        print len(proto_dat.rsp_res)
        for result in proto_dat.rsp_res:
           returnbuf+="<br>"
           returnbuf+= (result.category_name + " --  " + str(result.category_weight))
        tcpCliSock.close()
        return returnbuf 
